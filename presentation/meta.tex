%Meta-Informationen%
\newcommand{\mytitleGer}{Effiziente parallele Algorithmen zur großskaligen Personenstromsimulation}
\newcommand{\mytitleEng}{Efficient parallel algorithms for large-scale pedestrian simulation}
\newcommand{\myfakultaet}{Informatics}
